class CreditApplication < ApplicationRecord
  ...
  validates :employment_status, inclusion: { in: CreditApplication.employment_statuses.values }, allow_blank: true
  validates :salary_range, inclusion: { in: CreditApplication.salary_ranges.values }, allow_blank: true
  validates :verification_method, inclusion: { in: CreditApplication.verification_methods.values }, allow_blank: true
